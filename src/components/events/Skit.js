    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const mappedData = rows.map(row => ({
                ...
                usn: row._rawData[3],
                groupNames: row._rawData[6],
                groupUSN: row._rawData[7],
              }));
        ...
        <Table className={classes.table} aria-label="customized table">
          <TableHead>
            <TableRow className='header'>
              ...
              <TableCell className={classes.header}>Group Names</TableCell>
              <TableCell className={classes.header}>Group Usn's</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
          {data.map((item, index) => (
              ...
              <TableCell className={classes.cell}>{item.groupNames}</TableCell>
              <TableCell className={classes.cell}>{item.groupUSN}</TableCell>
                </TableRow>
            ))}
          </TableBody>
        </Table>
