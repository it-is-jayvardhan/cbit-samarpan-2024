...
export default function Anthyakshari(){
    ...
    useEffect(() => {
        async function fetchData() {
            ...
            const mappedData = rows.map(row => ({
              ...
              nameTeam:row._rawData[7],
              usnTeam:row._rawData[8],
              agreement:row._rawData[9],
        ...
        <Table className={classes.table} aria-label="customized table">
          <TableHead>
            <TableRow className='header'>
              ...
              <TableCell className={classes.header}>Name's of Team</TableCell>
              <TableCell className={classes.header}>USN's of Team</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
          {data.map((item, index) => (
              ...
              <TableCell className={classes.cell}>{item.nameTeam}</TableCell>
              <TableCell className={classes.cell}>{item.usnTeam}</TableCell>
                </TableRow>
            ))}
          </TableBody>
        </Table>
